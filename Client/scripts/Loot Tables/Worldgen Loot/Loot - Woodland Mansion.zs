...
treasure.addItemEntryHelper(<minecraft:filled_map>, 8, 0, [Functions.parse({"function": "quark:set_treasure"})], []);
...
treasure.addItemEntry(<wings:blue_butterfly_wings>, 1, 0);
treasure.addItemEntry(<wings:monarch_butterfly_wings>, 1, 0);
treasure.addItemEntry(<wings:fairy_wings>, 1, 0);