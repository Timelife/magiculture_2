...
filler.addItemEntryHelper(<minecraft:apple>, 30, 0, [Functions.setCount(1, 3)], []);
filler.addItemEntryHelper(<minecraft:bread>, 30, 0, [Functions.setCount(1, 2)], []);
...
goodies.addItemEntryHelper(<ebwizardry:scroll>, 30, 0, [Functions.parse({"function": "ebwizardry:random_spell", "tiers": ["apprentice"]})], []);
goodies.addItemEntryHelper(<ebwizardry:scroll>, 15, 0, [Functions.parse({"function": "ebwizardry:random_spell", "tiers": ["advanced"]})], []);
