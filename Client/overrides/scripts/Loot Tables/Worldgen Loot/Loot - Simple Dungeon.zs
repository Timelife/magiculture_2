...
goodies.addItemEntryHelper(<ebwizardry:scroll>, 15, 0, [Functions.parse({"ignore_weighting": false, "function": "ebwizardry:random_spell"})], []);
...
equipment.addLootTableEntry("ebwizardry:subsets/novice_wands", 10, 0);
...
treasure.addItemEntryHelper(<minecraft:filled_map>, 10, 0, [Functions.parse({"function": "quark:set_treasure"})], []);
treasure.addItemEntry(<ebwizardry:armour_upgrade>, 5, 0);
treasure.addItemEntry(<qualitytools:emerald_ring>, 7, 0);
treasure.addItemEntry(<qualitytools:emerald_amulet>, 5, 0);
