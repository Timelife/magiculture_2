...
var zsItem = VanillaFactory.createItem("tome_eng");
...
zsItem.itemRightClick = function(stack, world, player, hand) {
	if(player.hasGameStage("engineering")) { 
    ...
    Commands.call("title @s subtitle {\"text\":\"Engineering\"}", player, world, false, true);
