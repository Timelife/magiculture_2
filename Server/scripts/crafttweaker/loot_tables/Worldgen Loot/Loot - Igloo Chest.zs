...
# engineering
goodies.addLootTableEntryHelper("enderio:chests/igloo_chest", 8, 0, [Conditions.parse({"condition": "required_stage","stage_name": "Engineering"})]);
...
treasure.addItemEntryHelper(<minecraft:enchanted_book:0>.withTag({StoredEnchantments: [{lvl: 1 as short, id: 9 as short}]}), 7, 0, [], []); # FROST WALKER
