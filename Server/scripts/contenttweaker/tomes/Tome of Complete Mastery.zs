...
var zsItem = VanillaFactory.createItem("tome_master_complete");
...
zsItem.itemRightClick = function(stack, world, player, hand) {
	if(player.hasGameStage("complete_mastery")) { 
    ...
    Commands.call("title @s subtitle {\"text\":\"Complete Mastery\"}", player, world, false, true);
